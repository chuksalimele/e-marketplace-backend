...
set JARPATH=%APP_HOME%\lib\mcsv-common-lib.jar

@rem Execute mcsv-common-lib
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MCSV_COMMON_LIB_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MCSV_COMMON_LIB_EXIT_CONSOLE%" exit 1
exit /b 1
