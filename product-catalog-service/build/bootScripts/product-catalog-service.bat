...
set JARPATH=%APP_HOME%\lib\product-catalog-service.jar

@rem Execute product-catalog-service
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PRODUCT_CATALOG_SERVICE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%PRODUCT_CATALOG_SERVICE_EXIT_CONSOLE%" exit 1
exit /b 1
