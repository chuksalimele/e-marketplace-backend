 ...
 */
package com.aliwudi.marketplace.backend.lgtmed;
...
public class LogisticsMediaServiceApplication {

    public static void main(String[] args) {
        
        CliOptionsBootstrapper.check(LogisticsMediaServiceApplication.class, args);
        
        SpringApplication.run(LogisticsMediaServiceApplication.class, args);
    } 
}
